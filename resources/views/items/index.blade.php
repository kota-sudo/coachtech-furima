    ...
    <div class="mb-6 border-b border-gray-200">
        <nav class="flex gap-6">
            <a
                ...
                class="pb-3 text-sm font-medium border-b-2 {{ $tab === 'recommend' ? 'border-red-500 text-red-500' : 'border-transparent text-gray-500 hover:text-gray-700' }}"
            >
                おすすめ
            </a>
            <a
                href="{{ route('items.index', array_filter(['tab' => 'mylist', 'keyword' => $keyword ?: null])) }}"
                class="pb-3 text-sm font-medium border-b-2 {{ $tab === 'mylist' ? 'border-red-500 text-red-500' : 'border-transparent text-gray-500 hover:text-gray-700' }}"
            >
                マイリスト
            </a>
        </nav>
